...
# along with this program.  If not, see <https://www.gnu.org/licenses/>.
{
  ...
  inputs = rec {
    ...
    pythoneda-realm-rydnr-events = {
      ...
      url = "github:pythoneda-realm-rydnr-def/events/0.0.33";
    };
    pythoneda-realm-rydnr-events-infrastructure = {
      ...
      url = "github:pythoneda-realm-rydnr-def/events-infrastructure/0.0.34";
    };
    pythoneda-realm-rydnr-realm = {
      ...
      inputs.pythoneda-shared-pythonlang-domain.follows =
        "pythoneda-shared-pythonlang-domain";
      url = "github:pythoneda-realm-rydnr-def/realm/0.0.42";
    };
    pythoneda-shared-artifact-events = {
      inputs.flake-utils.follows = "flake-utils";
      inputs.nixos.follows = "nixos";
